...
public interface PositionssenderApi {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 405, message = "Invalide Daten")})
    @RequestMapping(value = "/positionssender/findInRadius",
            produces = {"application/json"},
            method = RequestMethod.GET)
    ResponseEntity<List<PositionssenderDTO>> findPositionssenderInRadius(@NotNull @ApiParam(value = "Radius um die Position, in welcher gesucht werden soll.", required = true) @Valid @RequestParam(value = "radius", required = true) Double radius
            , @NotNull @ApiParam(value = "Laengengrad des Radius um die Position, in welcher gesucht werden soll.", required = true) @Valid @RequestParam(value = "laengengrad", required = true) Double laengengrad
            , @NotNull @ApiParam(value = "Breitengrad des Radius um die Position, in welcher gesucht werden soll.", required = true) @Valid @RequestParam(value = "breitengrad", required = true) Double breitengrad
    );
    ...
    ResponseEntity<PositionssenderDTO> updatePositionssender(@ApiParam(value = "Objekt eines Positionssenders, welches aktualisiert werden soll.", required = true) @Valid @RequestBody PositionssenderDTO body
            , @ApiParam(value = "ID des Positionssender der aktualisiert werden soll.", required = true) @PathVariable("id") String id
    );
