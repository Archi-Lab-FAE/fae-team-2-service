...
public class ZoneApiController implements ZoneApi {
    ...
    public ResponseEntity<Zone> addZone(@ApiParam(value = "Objekt, welches angelegt werden soll.", required = true) @Valid @RequestBody Zone body) {
        String accept = request.getHeader("Accept");
        return new ResponseEntity<Zone>(HttpStatus.NOT_IMPLEMENTED);
    }

    public ResponseEntity<Zone> getZone(@ApiParam(value = "ID der Zone die zurückgeliefert werden soll.", required = true) @PathVariable("id") String id) {
        String accept = request.getHeader("Accept");
        return new ResponseEntity<Zone>(HttpStatus.NOT_IMPLEMENTED);
    }

    public ResponseEntity<Zone> updateZone(@ApiParam(value = "Objekt einer Zone, welches aktualisiert werden soll.", required = true) @Valid @RequestBody Zone body, @ApiParam(value = "ID der Zone die aktualisiert werden soll.", required = true) @PathVariable("id") String id) {
        String accept = request.getHeader("Accept");
        return new ResponseEntity<Zone>(HttpStatus.NOT_IMPLEMENTED);
    }
