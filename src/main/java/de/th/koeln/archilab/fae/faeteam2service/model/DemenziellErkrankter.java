...
public class DemenziellErkrankter {
    ...
    public DemenziellErkrankter demenziellErkrankterId(String demenziellErkrankterId) {
    ...
    public DemenziellErkrankter name(String name) {
        this.name = name;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        DemenziellErkrankter demenziellErkrankter = (DemenziellErkrankter) o;
    ...
    public String toString() {
        ...
        sb.append("class DemenziellErkrankter {\n");
